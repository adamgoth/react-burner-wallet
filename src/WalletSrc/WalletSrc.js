...
class App extends Component {
  ...
  get buttonStyle() {
    return {
      primary: {
        backgroundImage:
          "linear-gradient(" +
          this.mainStyle.mainColorAlt +
          "," +
          this.mainStyle.mainColor +
          ")",
        backgroundColor: this.mainStyle.mainColor,
        color: "#FFFFFF",
        whiteSpace: "nowrap",
        cursor: "pointer",
      },
      secondary: {
        border: "2px solid " + this.mainStyle.mainColor,
        color: this.mainStyle.mainColor,
        whiteSpace: "nowrap",
        cursor: "pointer",
      },
    }
  ...
  componentDidMount() {
    document.body.style.backgroundColor = this.mainStyle.backgroundColor
    console.log(
  ...
  async chainClaim(tx, contracts) {
    ...
    if (fund && parseInt(fund.nonce) > 0) {
      ...
      tx(
        contracts.Links.claim(this.state.claimId, sig, claimHash, this.state.account),
        240000,
        false,
        0,
        result => {
...
*/
      ...
      for (let t in transactions) {
        ...
        if (tx && tx.to && tx.from) {
          ...
          if (
            ...
            updatedTxs =
              this.addTxIfAccountMatches(recentTxs, transactionsByAddress, smallerTx) ||
              updatedTxs
          }
        }
      }
  ...
  async addAllTransactionsFromList(recentTxs, transactionsByAddress, theList) {
    ...
    for (let e in theList) {
      ...
      updatedTxs =
        this.addTxIfAccountMatches(recentTxs, transactionsByAddress, cleanEvent) ||
        updatedTxs
    }
    return updatedTxs
  }
                          ...
                          <Events
                            ...
                            onUpdate={(vendor, all) => {
                              ...
                              if (
                                ...
                                vendors[vendor.vendor].blockNumber < vendor.blockNumber
                              ) {
                                vendors[vendor.vendor] = {
                        ...
                        <div>
                          ...
                          >
                            <NavCard
                              ...
                              titleLink={
                                this.state.badges[this.state.selectedBadge].external_url
                              }
                              goBack={this.goBack.bind(this)}
                            />
                            <SendBadge
                          ...
                          <Bottom text={i18n.t("done")} action={this.goBack.bind(this)} />
                        </div>
                      )
                    ...
                    case "loader":
                      return (
                        <div>
                          ...
                          <Loader loaderImage={LOADERIMAGE} mainStyle={this.mainStyle} />
                        </div>
                      )
                    case "reader":
                      return (
                        ...
                        if (localStorage && typeof localStorage.setItem == "function") {
                          ...
                          if (!loadedBlocksTop || loadedBlocksTop < this.state.block) {
                            ...
                            let paddedLoadedBlocks =
                              parseInt(loadedBlocksTop) + BLOCKS_TO_PARSE_PER_BLOCKTIME
                            ...
                            console.log(
                              " +++++++======= Parsing recent blocks ~" + this.state.block
                            )
