...
class SendByScan extends Component {
  ...
  render() {
    ...
    if (this.state.imageData) {
      displayedImage = (
        <img
          style={{ maxWidth: "100%", width: "100%", opacity: 0.7 }}
    ...
    if (this.state.isLoading) {
      ...
      loaderDisplay = (
        <div className="loaderDisplay" style={{ textAlign: "center" }}>
          <div style={{ width: "100%" }}>
    ...
    if (this.state.legacyMode) {
      displayedReader = (
        ...
        >
          ...
          >
            <div
              className="FileReaderInput-child"
              style={{
                position: "absolute",
                zIndex: 11,
                top: 0,
              ...
              <div style={{ textAlign: "center", paddingTop: "10px" }}>
                ...
                >
                  <div
                    ...
                    style={{ paddingLeft: "12%", paddingRight: "12%", paddingTop: 10 }}
                  >
                    <button
